...
class EdulevelController extends Controller
{
    ...
    {
        $surats = Surat::paginate(5); // Menambahkan pagination dengan 5 item per halaman
        $user = User::all();
        $jenis_surat = JenisSurat::all();

        return view('surat.index', compact('surats', 'user', 'jenis_surat'));
    }
    ...
    public function data()
    {
        ...
        return view('page.index', compact('jenis_surat', 'user', 'surats'));
    }
