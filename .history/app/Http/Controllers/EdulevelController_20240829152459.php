...
class EdulevelController extends Controller
{
    ...
    {
        // Fetch the surat record by its ID
        $surat = Surat::findOrFail($id);
    
        // Fetch all users for the dropdown
        $user = User::all();
    
        // Fetch all types of surat for the dropdown
        $jenis_surat = JenisSurat::all();
    
        // Pass the surat, user, and jenis_surat data to the view
