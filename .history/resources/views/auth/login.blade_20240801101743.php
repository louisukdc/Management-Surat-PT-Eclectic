...
<body>
    <section class="bg-gray-50 dark:bg-gray-900">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen 3xl:py-0">
            <div class="flex items-center 3xl-6 text-2xl font-semibold text-gray-900 dark:text-white">
                Login
            </div>
