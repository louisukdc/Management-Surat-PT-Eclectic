        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-3xl xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-12 space-y-6 md:space-y-9 sm:p-12 flex flex-col items-center">
                    <img src="{{ asset('assets/img/logo-EC.png') }}" alt="Logo" class="w-72 h-auto mb-6">
                    <h1 class="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white w-72 h-auto mb-6">
