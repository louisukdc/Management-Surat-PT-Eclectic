        ...
        <div class="bg-white shadow-md rounded-lg">
            ...
            <div class="px-6 py-4">
                <div class="mb-4 flex justify-between items-center">
                    ...
                    <form action="{{ url('show/{id}') }}" method="GET" class="flex">
                        <input type="text" name="search" placeholder="Search..." value="{{ $search }}" class="px-4 py-2 border border-gray-300 rounded-l-md">
                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="py-3 px-6 text-center">
                                <div class="flex item-center justify-center">
                                    <a href="{{ url('surats/'.$surat->id) }}" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                ...
                <div class="mt-4">
                    {{ $surats->appends(['search' => $search])->links() }}
                </div>
            </div>
        </div>
    </div>
