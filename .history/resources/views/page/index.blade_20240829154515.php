        ...
        <div class="bg-white shadow-md rounded-lg">
            ...
            <div class="px-6 py-4">
                <div class="mb-4 flex justify-between items-center">
                    <a href="{{ url('edit') }}" class="bg-green-500 text-white text-xl px-6 py-2 rounded-md hover:bg-green-600 no-underline hover:no-underline">
                        Tambah Surat
                    </a>                                       
                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="py-3 px-6 text-center">
                                <div class="flex item-center justify-center">
                                    ...
                                    <a href="{{ route('surat.edit', $surat->id) }}" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
