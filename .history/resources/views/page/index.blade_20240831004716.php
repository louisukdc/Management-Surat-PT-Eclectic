        ...
        <div class="bg-white shadow-md rounded-lg">
            ...
            <div class="px-6 py-4">
                <div class="mb-4 flex justify-between items-center">
                    ...
                    <form method="get" action="{{ route('surat.search') }}" class="flex">
                        <input type="text" name="search" placeholder="Search..." value="{{ isset($search) ? $search : '' }}" class="px-4 py-2 border border-gray-300 rounded-l-md">
