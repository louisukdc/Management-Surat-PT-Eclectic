...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <h3>{{$suratsponsorship->nomor}}</h3>
            <table class="job">
                <tr style="width:105%">
                    <td class="forleft2"  colspan="2">
                        <p class="job1">{{$suratsponsorship->tempat_buat}}, {{Carbon\Carbon::parse($suratsponsorship->tgl_buat)->format('M d Y')}}</p>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" >
                        <b>
                            <p>To:</p>
                            <p class="job3" style="margin-right: 150px; width: 35%">{{$dataDetailsponsorship['To']}}</p>
                            <p class="job3" style="margin-right: 150px; width: 35%">{{$dataDetailsponsorship['Tox']}}</p>
                            <p class="job3" style="margin-right: 150px; width: 35%">{{$dataDetailsponsorship['Toxy']}}</p>
                        </b>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <p class="job3">Here with certify that</p>
                        <p class="job3">Name</p>
                        <p class="job2 english">Position</p>
                        <p class="job2 english">Passport No.</p>
                    </td>
                    <td style="width: 90%;">
