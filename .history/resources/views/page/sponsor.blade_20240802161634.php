                    ...
                    <div class="container mx-auto">
                        ...
                        <div class="w-full text-justify">
                            <p class="mb-4 text-xl">
                                Dengan Hormat,<br>
                                Kami mewakili PT Eclectic Consulting Menyampaikan informasi bahwa Anda terpilih untuk mengisi posisi {{ $dataDetailsponsorship['Posisi'] }} di perusahaan kami.<br>
                                ...
                                Apabila menerima tawaran ini, Anda akan memegang posisi sebagai {{ $dataDetailsponsorship['Posisi'] }} dan akan bertugas di Project Kami Yang sedang berjalan. Anda akan bertugas {{ $dataDetailsponsorship['Bertugas'] }}.<br>
                                Kami berharap Anda dapat bergabung dengan kami pada tanggal {{ $dataDetailsponsorship['Tanggal'] }}, Seandainya berhalangan pada tanggal tersebut, kami mohon Anda dapat segera menghubungi dan memberitahukan kepada kami. Anda diharapkan untuk bekerja menyesuaikan project yang sedang berjalan.<br>
                                Anda akan menjalani masa percobaan selama {{ $dataDetailsponsorship['Selama'] }}, yang mana dalam waktu tersebut masing-masing pihak berhak memutuskan hubungan kerja dengan memberikan pemberitahuan tertulis {{ $dataDetailsponsorship['Tertulis'] }} sebelumnya.<br>
