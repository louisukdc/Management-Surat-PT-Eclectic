                    ...
                    <div class="container mx-auto">
                        ...
                        <div class="w-full text-justify">
                            <p class="mb-4 text-xl">
                                ...
                                Apabila menerima tawaran ini, Anda akan memegang posisi sebagai {{ $dataDetailsponsorship['Position'] }} dan akan bertugas di Project Kami Yang sedang berjalan. Anda akan bertugas {{ $dataDetailsponsorship['Bertugas'] }}.<br>
