    ...
    <form action="{{ route('surat.update', $surat->id) }}" method="POST">
        ...
        <div class="row">
            <div class="col mb-3">
                ...
                <input type="text" name="nomorurut" class="form-control" placeholder="nomorurut" value="{{ $surat->nomorsurat }}" >
            </div>
            <div class="col mb-3">
                <label class="form-label">Nomor Surat</label>
                <input type="text" name="nomorsurat" class="form-control" placeholder="nomorsurat" value="{{ $product->price }}" >
            </div>
        </div>
        <div class="row">
            <div class="col mb-3">
