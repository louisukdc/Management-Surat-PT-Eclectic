    ...
    <form action="{{ route('surat.update', $surat->id) }}" method="POST">
        ...
        <div class="row">
            ...
            <div class="col mb-3">
                ...
                <input type="text" name="jabatan_pembuat" class="form-control" placeholder="jabatan_pembuat" value="{{ $product->jabatan_pembuat }}" >
            </div>
            <div class="col mb-3">
                <label class="form-label">Id Tipe Surat</label>
                <input type="text" name="id_tipe_surat" class="form-control" placeholder="id_tipe_surat" value="{{ $product->id_tipe_surat }}" >
            </div>
        </div>
        <div class="row">
            <div class="d-grid">
