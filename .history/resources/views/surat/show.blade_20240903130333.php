            ...
            <div class="bg-white shadow-md rounded-lg">
                ...
                <div class="p-6">
                    <div class="container mx-auto">
                        <h1 class="text-center text-3xl font-bold underline mb-6">OFFERING LETTER II</h1>
                        ...
                        <div class="w-full text-justify">
                            <p class="mb-4 text-xl">
                                ...
                                Apabila menerima tawaran ini, Anda akan memegang posisi sebagai{!! $surat->tgl_buat !!} dan akan bertugas di Project Kami Yang sedang berjalan. Anda akan bertugas {!! $surat->jabatan_pembuat !!}.<br>
                                ...
                                Anda akan menjalani masa percobaan selama {!! $surat->nama_pembuat !!}, yang mana dalam waktu tersebut masing-masing pihak berhak memutuskan hubungan kerja dengan memberikan pemberitahuan tertulis {!! $surat->jabatan_pembuat !!} sebelumnya.<br>
                            ...
                            <p class="mb-4 text-xl english">
                                Yang akan dibayarkan setiap bulan melalui {!! $surat->jabatan_pembuat !!} pada akhir bulan. Perusahaan memberi Anda hak cuti {!! $surat->jabatan_pembuat !!}.<br>
                            </p>
                        </div>
                        <div class="w-full text-justify">
