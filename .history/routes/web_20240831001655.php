...
Route::get('edit', [EdulevelController::class, 'edit']);
...
Route::resource('/surat', EdulevelController::class);
Route::get('page/index', [EdulevelController::class, 'index'])->name('page.index');
Route::get('/surat/{id}/edit', [EdulevelController::class, 'edit'])->name('surat.edit');
Route::get('/search', [EdulevelController::class, 'search'])->name('posts.search');
